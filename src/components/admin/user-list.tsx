        ...
        <div className="space-y-6">
            ...
            {showAddForm && (
                <form
                    ...
                    className="p-6 bg-neutral-900 rounded-xl border border-neutral-800 space-y-4 max-w-lg"
                >
                    <h3 className="text-sm text-neutral-400 mb-2">新建用户</h3>
                    <div className="grid grid-cols-2 gap-4">
                        <input
                            ...
                            placeholder="用户名"
                            className="px-3 py-2 bg-neutral-800 border border-neutral-700 rounded-lg text-white text-sm focus:outline-none focus:border-neutral-500"
                            required
                        />
                        <input
                            type="password"
                ...
                {users.map((user) => (
                    ...
                    >
                        <div className="flex items-center gap-4">
                            {/* Avatar placeholder */}
                            <div className="w-10 h-10 rounded-full bg-neutral-800 flex items-center justify-center text-sm text-neutral-400 font-medium">
                            ...
                            <div>
                                <div className="flex items-center gap-2">
                                    ...
                                    {user.id === currentUserId && (
                                        <span className="text-xs text-neutral-600">（当前）</span>
                                    )}
                                </div>
